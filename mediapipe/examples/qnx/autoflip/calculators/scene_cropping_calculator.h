...
#include "mediapipe/examples/qnx/autoflip/calculators/scene_cropping_calculator.pb.h"
...
#include "mediapipe/examples/qnx/autoflip/quality/frame_crop_region_computer.h"
